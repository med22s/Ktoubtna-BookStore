...
const bookSchema = [
    ...
    .isLength({min : 6}).withMessage("author must be greather than 6")
    ...
    .isLength({min : 10}).withMessage("description must be greather than 10")
    ...
    .isLength({min : 6}).withMessage("genre must be greather than 10")
