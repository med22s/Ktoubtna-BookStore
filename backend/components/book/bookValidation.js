...
const bookSchema = [
    ...
    .isLength({max : 500}).withMessage("description must be less than 500")
    ,
    ...
    ,
    body('price').trim().default(0).isDecimal().withMessage("The Book price must be a decimal")
    ,
    body('numberInStock').trim().default(0).isNumeric().withMessage("The numberInStock must be Number")
]
