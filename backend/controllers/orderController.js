...
const updateOrderOnDeliver = asyncHandler(async (req, res) => {
  const order = await Order.findById(req.params.id)
...
export {addOrder,getSingleOrderById,updateOrderAsPaid,getMyOrders,getAllOrders,updateOrderOnDeliver}